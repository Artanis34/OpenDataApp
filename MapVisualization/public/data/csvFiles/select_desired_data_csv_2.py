"""
DISCLAIMER: This python file is needed if the geoData2 is implemented, it selects both the GeoPoints from verkehrspunktelemente_actualdate
and dienststellen_actualdate, to get all the points possible.

Script: select_desired_data_csv_2.py
